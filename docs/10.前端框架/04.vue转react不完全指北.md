...
> 老东家 Vue，加实习写了两年半~，期间只是简单学过 React，没怎么写过。新东家用 React + Typescript，用了一个半月，写了写[Demo 在线预览](https://wuchuan99.github.io/docs//study/)。
>
>这里简单总结下和vue的区别，如果你也是在Vue转React阶段，欢迎加V交流[扫码加V](https://wuchuan99.github.io/docs//)
>
> 有不同见解，欢迎评论区指教🤓
...
- 为了提高熟练度，用公司的组件库（[zent](https://youzan.github.io/zent/zh/guides/install)）自己动手写了写，有兴趣的老哥参考下：在线预览:[无妄子学习系统](https://wuchuan99.github.io/docs//study/)  Github 源码:[基于 react + typescript ](https://github.com/alexwjj/react-ts) 欢迎`start`
