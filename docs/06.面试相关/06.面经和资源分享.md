...
## 一、简历
一定要有`亮点`！！！名校、大厂、工作经验、个人博客、开源项目等等。如果说都没有，来，`现成的`，把我的博客fork一份拿去自己用，搭建教程博客也有，求个`start`。[无妄子的博客 GitHub](https://github.com/wuchuan99/docs)
### 1、总体
...
- 微信：V798595965（博客可直接扫码 [无妄子的个人博客](https://wuchuan99.github.io/docs//)）
