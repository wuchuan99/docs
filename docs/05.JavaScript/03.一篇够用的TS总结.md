...
> 首发博客：[川的学习基地](https://alexwjj.github.io/) 欢迎star，一起学习！博客主页有吹水群，扫码加入！
...
const objectArr: IItem[] = [{ id: 1, name: '川', isGod: true }];
// or
const objectArr: Array<IItem> = [{ id: 1, name: '川', isGod: true }];
